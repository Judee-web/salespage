<template>
  <div class="relative pb-[400px] bg-white">
      ...
      <div class="bg-[#0D0E25] w-[94vw] lg:w-[98vw] rounded-xl mx-auto -rotate-1 pb-80">
          ...
          <div class="text-white rotate-1 flex justify-around items-center flex-wrap pt-20 pb-0">

          <div class="w-[580px] md:px-0 px-3">
              <div class="flex items-center">
                  <div class="border border-white w-[45px]"></div>
                  <p class="font-title font-semibold text-base ml-4">I WAS ALSO A NOBODY</p>
              </div>
    ...
    <div class="flex md:flex-row flex-col items-center justify-center">
        <button class="py-3 px-5 w-max text-white font-dmsans rounded-full bg-[#FC881D] shadow-xl shadow-[#d499622f] hover:bg-[#ff912a] transition-all" v-on:click.native='btnClick'>Get Started</button>
                                ...
                                <div class="absolute w-max p-5 rounded-xl bg-white shadow-xl left-0 right-0 -bottom-96 md:-bottom-[400px] lg:-bottom-80 mx-auto rotate-1 flex flex-col lg:flex-row">
            ...
            <div class="w-[250px] md:w-[300px] xl:w-[500px] md:mr-3 relative">
                ...
                <p class="font-title font-normal text-base md:text-xl py-6">
                   I will hold you by the hand and grant you the exact formula that worked for me and can work for you also.
                </p>

                <div class="flex absolute bottom-0">
                    <a href="https://wa.link/fsg4ik">Learn More </a>
